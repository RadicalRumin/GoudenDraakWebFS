...
<template>
    ...
    <header
        class="flex flex-col lg:flex-row justify-center items-center bg-[#ff0000] font-chineseTakeaway text-xl h-[20vh]">
        ...
        <div class="text-[#ffff00] p-2 w-full lg:w-1/3 flex justify-center items-center">
            <img class="h-14 align-middle" :src="dragonImage" alt="Golden Dragon">
            <span class="mx-2">De Gouden Draak</span>
            <img class="h-14 align-middle scale-x-[-1]" :src="dragonImage" alt="Golden Dragon">
        </div>

        <!-- Second section (always visible, stacks under first on small screens) -->
        <div class="text-[#ffff00] p-2 w-full lg:w-1/3 flex justify-center items-center overflow-hidden">
        ...
        <div class="text-[#ffff00] p-2 w-full lg:w-1/3 lg:flex hidden lg:justify-center lg:items-center">
            <img class="h-14 align-middle" :src="dragonImage" alt="Golden Dragon">
            <span class="mx-2">De Gouden Draak</span>
            <img class="h-14 align-middle scale-x-[-1]" :src="dragonImage" alt=" Golden Dragon">
        </div>
